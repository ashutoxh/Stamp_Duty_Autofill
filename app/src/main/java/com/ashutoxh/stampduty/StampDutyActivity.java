...
public class StampDutyActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            mWebView.setWebViewClient(new WebViewClient() {
                ...
                public void onPageFinished(WebView view, String url) {
                    ...
                    if (url.contains(getResources().getString(R.string.indexURI))) {
                        ...
                        MainActivity.boeNoTxt.setText("");
                        MainActivity.boeDateTxt.setText("");
                        MainActivity.igmNoTxt.setText("");
                        MainActivity.itemNoTxt.setText("");
                        MainActivity.amountTxt.setText("");
                ...
                private void injectScriptFile(WebView view) {
                    ...
                    try {
                        ...
                        Log.e("StampDutyActivity", "injectScriptFile : " + e.getMessage());
            ...
            Log.e("StampDutyActivity", "onCreate " + e.getMessage());
            FirebaseCrashlytics.getInstance().recordException(e);
        }
    }
